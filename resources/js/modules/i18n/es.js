export default {
    ...
    donation: {
        army: {
            ...
            content:
                '<p>Banco: Banco Nacional de Ucrania</p>' +
                '<p>Código MFO 300001</p>' +
                '<p>Número de cuenta. UA843000010000000047330992708</p>' +
                '<p>Código EDRPOU  00032106</p>' +
                '<p>Beneficiario: Banco Nacional de Ucrania</p>',
        },
        support: {
